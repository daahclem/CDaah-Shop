            ...
            <div class="row justify-content-center">
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  <h1 class="fw-bold">CDAAH SHOP</h1>
                  <ul class="list-unstyled text-uppercase">
                    <li>open from 08:00 AM - 15:00 PM</li>
                    <li class="mb-3">Bradford</li>
                  </ul>
                  <span class="me-3"><i class="fa-brands fa-instagram"></i> cdaashop </span>
                  <span><i class="fa-brands fa-whatsapp"></i> +447823848779</span>
                </div>
              </div>
            </div>
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <a href="https://www.instagram.com/" target="_blank" class="text-warning">C DAAH</a> © 2021 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
